#!/bin/bash
BASE_URL="http://localhost:5001/reservations"
...
echo "Table Capacity (4 guests at T1/ID 1, Capacity 3)"
curl -s -X POST $BASE_URL -H "Content-Type: application/json" -d '{"tableId": 1, "name": "Fail Capacity", "phone": "123", "date": "2026-05-16", "time": "19:00", "guests": 4}'
